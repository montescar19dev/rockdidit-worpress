...
if (!function_exists('uicore_setup')) :
	...
	function uicore_setup()
	{
		 ...
		 * to change 'pagebolt' to the name of your theme in all the template files.
		 */
		load_theme_textdomain('pagebolt', get_template_directory() . '/languages');
		...
		register_nav_menus(array(
			'primary' => esc_html__('Primary', 'pagebolt'),
		));
